...
Write-Host "1️⃣  Configure Python environment:"
Write-Host "   python -m venv venv"
Write-Host "   .\venv\Scripts\Activate.ps1"
Write-Host ""
Write-Host "2️⃣  Install dependencies:"
Write-Host "   cd backend"
Write-Host "   pip install -r requirements.txt"
Write-Host ""
Write-Host "3️⃣  Run backend tests:"
Write-Host "   python -m pytest tests/ -v"
Write-Host ""
Write-Host "4️⃣  Install frontend dependencies:"
Write-Host "   cd ../frontend"
Write-Host "   npm install"
Write-Host ""
Write-Host "5️⃣  Start all services:"
Write-Host "   cd .."
